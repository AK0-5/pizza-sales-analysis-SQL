...
-- Group the orders of date and calculate the average number of pizzas ordered per day
SELECT 
...
FROM
    ...
    ORDER BY Quantity DESC) AS Order_Quantity_AVG;
...
GROUP BY orders.order_date) AS sales ORDER BY cum_revenue DESC;
